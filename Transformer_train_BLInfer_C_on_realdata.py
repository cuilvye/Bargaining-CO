...
def learning_model_paras_V0(dataframe_prior_train, dataframe_prior_valid, par_t_set, epsilon, classes, epochs, batch_size, lr, syn_tag, vs_disType, dis_pars, save_tuple, path_tuple):
    ...
    for t_val in par_t_set_running:
        ...
        for epoch in range(t_val_start, epochs):
            ...
            loss_v, acc_v, vsAcc_v = performance_on_RealData_Multirows_V0_alpha_log_BF_transformer(dataframe_prior_valid,
                                                                                                t_val, epsilon,
                                                                                                classes, batch_size,
                                                                                                syn_tag,
                                                                                                vs_disType, dis_pars,
...
path_model = save_data_tag + '/Transformer_BF_RNN_Split_' + str(split_idx) +'_Ours_Classes_'+ str(classes) + '_epsilon_' + str(epsilon) +'_models/'
path_res = save_data_tag +'/Transformer_BF_RNN_Split_' + str(split_idx) + '_Ours_Classes_'+ str(classes) + '_epsilon_' + str(epsilon) +'_results/'
